...
<Frame>
  <img src="/img/developerapi/api-key-list.png" alt="Developer API key list" />
</Frame>

3. Enter a name for your key. You can not use the same name for multiple keys.

<Frame>
  <img src="/img/developerapi/api-key-create.png" alt="Create a Developer API key" />
</Frame>

<Frame>
  <img src="/img/developerapi/api-key-secret.png" alt="Developer API key secret" />
</Frame>

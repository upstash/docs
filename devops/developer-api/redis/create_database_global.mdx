...
<ParamField body="plan" type="string" required="false">
Specifies the fixed plan type for the database.
If this field is empty, the database is created using either the pay-as-you-go or free plan, depending on the account type.
Options: `fixed_250mb`, `fixed_1gb`, `fixed_5gb`, `fixed_10gb`, `fixed_50gb`,
`fixed_100gb`, `fixed_500gb`

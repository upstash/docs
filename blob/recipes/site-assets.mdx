...
description: "Editor uploads for a CMS, and site assets written by a deploy script."
---

<Frame>
  <img className="block dark:hidden" src="/img/blob/site-assets-light.gif" alt="Choose a cover image in the admin form, watch it upload, fill in the alt text and save, then replace it and see the site preview update on a new path" />
  <img className="hidden dark:block" src="/img/blob/site-assets-dark.gif" alt="Choose a cover image in the admin form, watch it upload, fill in the alt text and save, then replace it and see the site preview update on a new path" />
</Frame>

...
description: "Several ordered images per product, uploaded from the browser and rendered from your own rows."
---

<Frame>
  <img className="block dark:hidden" src="/img/blob/product-images-light.gif" alt="Add three images in the admin panel, watch them upload in parallel and appear on the product page as each finishes, then remove one from both" />
  <img className="hidden dark:block" src="/img/blob/product-images-dark.gif" alt="Add three images in the admin panel, watch them upload in parallel and appear on the product page as each finishes, then remove one from both" />
</Frame>

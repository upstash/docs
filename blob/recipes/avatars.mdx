...
description: "One picture per user, overwritten in place, uploaded from the browser, with the old one out of the cache."
---

<Frame>
  <img className="block dark:hidden" src="/img/blob/avatars-light.gif" alt="Click the avatar, pick a photo, watch it upload, then remove it" />
  <img className="hidden dark:block" src="/img/blob/avatars-dark.gif" alt="Click the avatar, pick a photo, watch it upload, then remove it" />
</Frame>

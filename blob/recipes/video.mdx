...
<Frame>
  <img className="block dark:hidden" src="/img/blob/video-light.gif" alt="Pick a large video, watch it upload in parts with size and time left, then play it back once the row is ready" />
  <img className="hidden dark:block" src="/img/blob/video-dark.gif" alt="Pick a large video, watch it upload in parts with size and time left, then play it back once the row is ready" />
</Frame>

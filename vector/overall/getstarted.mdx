...
<Frame style={{width: '600px'}}>
  <img src="/img/vector/getstarted/create_index.png" alt="Create a Vector index" />
</Frame>
...
<Frame style={{width: '600px'}}>
  <img src="/img/vector/getstarted/select_plan.png" alt="Select a Vector database plan"  />
</Frame>
...
<Frame style={{width: '600px'}}>
  <img src="/img/vector/getstarted/usage.png" alt="Vector index usage in the Upstash Console" />
</Frame>
...
You can also query your index with a simple UI:
  ...
  <img src="/img/vector/getstarted/browser.png" alt="Vector index data browser" />

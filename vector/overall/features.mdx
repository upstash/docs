...
<Frame>
  <img src="/img/vector/cosine_similarity.svg" width="90%" />
</Frame>
...
<Frame>
  <img src="/img/vector/squared_distance.svg" width="80%" />
</Frame>
...
<Frame>
  <img src="/img/vector/dot_product.svg" width="50%" />
</Frame>
...
```
curl https://powerful-kodiak-60521-us1-vector.upstash.io/query -H "Authorization: Bearer UPSTASH_VECTOR_TOKEN" \
  -d '{
   "vector":[0.9215,0.3897,...],
   "topK" : 5,
...
```
curl https://powerful-kodiak-60521-us1-vector.upstash.io/range -H "Authorization: Bearer UPSTASH_VECTOR_TOKEN" \

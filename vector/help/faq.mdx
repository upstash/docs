...
For pricing and a consolidated list of index limits, see [Pricing & Limits](/vector/overall/pricing).
...
- **What is the maximum dimension I can set for my indexes?**
    ...
    See the [dimension limits by plan](/vector/overall/pricing#limits).
...
- **Which cloud provider is Upstash Vector hosted on?**
    ...
    Upstash Vector is available on AWS and GCP. Availability depends on the plan; see [Regions](/vector/overall/pricing#regions).
    
- **In what regions is Upstash available?**
    
    See the [regions by plan](/vector/overall/pricing#regions).

...
<ResponseField name="vectorCount" type="number" required>
  ...
  This is the total number of vectors in all namespaces, if namespaces are used.
</ResponseField>
<ResponseField name="pendingVectorCount" type="number" required>
  ...
  use.
  This is the total number of pending vectors in all namespaces, if namespaces are used.
</ResponseField>

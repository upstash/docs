...
<Frame>
    <img width="400" src="/img/vector/integrations/flowise/vector-node.png" alt="Upstash Vector node in Flowise" />
</Frame>
...
<Frame>
    <img width="400" src="/img/vector/integrations/flowise/cache-node.png" alt="Upstash Redis cache node in Flowise" />
</Frame>
...
<Frame>
    <img width="400" src="/img/vector/integrations/flowise/chat-memory-node.png" alt="Upstash Redis chat memory node in Flowise" />
</Frame>
...
<Frame caption="You can use a document loader to upload documents and connect it to the Upstash Vector node for indexing.">
    <img src="/img/vector/integrations/flowise/flow.png" alt="You can use a document loader to upload documents and connect it to the Upstash Vector node for indexing." />
</Frame>

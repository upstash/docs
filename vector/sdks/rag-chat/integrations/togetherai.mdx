...
[Together AI](https://www.together.ai/) is a language model provider. Check out [Together AI API](https://api.together.ai/models) for more information about their models and pricing.
...
export const ragChat = new RAGChat({
  model: togetherai("meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo",{apiKey: process.env.TOGETHER_AI_KEY}),
});
```

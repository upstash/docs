...
[OpenRouter](https://openrouter.ai/) is a language model provider. Check out [OpenRouter Models](https://openrouter.ai/models) for more information about their models and pricing.
...
Create an OpenRouter account and get an API key from [OpenRouter -> Settings -> API Keys](https://openrouter.ai/settings/keys). Set your OpenRouter API key as an environment variable:
...
Initialize RAGChat with the OpenRouter model:
...
export const ragChat = new RAGChat({
  model: openrouter("sao10k/l3-lunaris-8b",{apiKey: process.env.OPEN_ROUTER_KEY}),
});
```

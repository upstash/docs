    ...
    <div className="u-grid u-grid--fixed3">
      {products.map((p) => (
        <a key={p.href} href={p.href} className="u-card u-product">
          <img className="u-card__icon" src={`/docs/docs-assets/img/icons/${p.icon}.svg`} alt="" />
...
export const AgentResources = () => {
  ...
  const items = [
    ...
    { name: "Context7", desc: "Up-to-date code docs for LLMs and agents.", href: "https://context7.com", icon: "/docs/docs-assets/img/icons/context7.svg" },
  ];
  return (

...
you need help, check [getting started](../../redis/overall/getstarted) guide. In the
database details page, go to the **Connect** section (**TCP** tab). You will need the endpoint,
port, and token in the next step. The token is also your database's password.
...
if (typeof client === "undefined") {
  var client = new Redis("rediss://default:YOUR_TOKEN@YOUR_ENDPOINT:YOUR_PORT");
}
...
<Snippet file="redis/ioredisnote" />

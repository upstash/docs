...
Create the Redis store layer with your Upstash connection string. You can find it under the **TCP** tab of the **Connect** section on your database page in the [Upstash Console](https://console.upstash.com). The URL must start with `rediss://` since Upstash requires TLS:

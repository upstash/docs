...
2. Note down your credentials in the details page, we will be using those to connect Redis
   ...
   <img src="/img/n8n/redis-credentials.png" alt="Upstash Redis credentials in n8n" />
...
2. Create a Trigger as Webhook with default settings, this will be our entry point. Our Redis instances gonna watch the visits to this url.
   <img src="/img/n8n/webhook.png" alt="Webhook node in an n8n workflow" />
...
1. Search for redis in nodes, and select increment action.
   <img src="/img/n8n/redis-1.png" alt="Add a Redis node in n8n" />
2. In the opening window, click select credentials, and create new credentials.
   ...
   <img src="/img/n8n/redis-2.png" alt="Select a Redis operation in n8n" />
3. Fill the credentials.
   ...
   <img src="/img/n8n/redis-3.png" alt="Configure Redis credentials in n8n" />

4. Enable SSL (Upstash Redis requires SSL) and hit the save button.
   <img src="/img/n8n/redis-4.png" alt="Configured Redis node in n8n" />
...
1. Track the users with `x-real-ip`
   <img src="/img/n8n/redis-increment.png" alt="Redis increment operation in n8n" />
2. Add another redis node with get action to see the visit counts
   <img src="/img/n8n/redis-get.png" alt="Redis get operation in n8n" />
3. Read the set visit count with redis get
   <img src="/img/n8n/redis-get-2.png" alt="Redis visit count result in n8n" />

...
The response is `{ "result": "098e0f0d1448c0a81dafe820f66d460eb09263da" }`.
Use this digest with [`EVALSHA`](/redis/commands/scripting/evalsha) or
[`EVALSHA_RO`](/redis/commands/scripting/evalsha-ro).

...
<Warning>
  Prefer [`HSET`](/redis/commands/hash/hset) with multiple field-value pairs in new code: `HSET <key> <field> <value> [<field> <value> ...]`. `HMSET` is deprecated in Redis but still supported by Upstash.
</Warning>

...
Bitmaps built this way are read back with [`GETBIT`](/redis/commands/bitmap/getbit), counted with [`BITCOUNT`](/redis/commands/bitmap/bitcount), and combined with [`BITOP`](/redis/commands/bitmap/bitop).

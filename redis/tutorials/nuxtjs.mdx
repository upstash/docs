---
id: "nuxtjs_with_redis"
title: "Nuxt.js with Redis"
description: "This tutorial shows how to use Upstash inside your NuxtJS application."
---

This tutorial uses Redis as state store for a Nuxt.js application. We simply increment a counter that pulls the data from
Redis.

See [code](https://github.com/upstash/examples/tree/master/nuxt-with-redis)
and [demo](https://nuxt-with-redis.vercel.app)

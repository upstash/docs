...
[guide](../overall/getstarted). Copy the Redis URL from the **Connect** section
(**TCP** tab) on the database page. We use ioredis in our application. Create
.env file and paste your Redis URL:

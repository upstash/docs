...
sidebar_label: Serverless Rate Limiting
description: "This tutorial shows how to limit rate in AWS Lambda with Serverless Redis."
---
                  
UPDATE: We have developed [Upstash Rate Limiting SDK](https://github.com/upstash/ratelimit). We recommend it with Upstash Redis.

In this tutorial, we will throttle AWS Lambda functions using Serverless Redis based on the client's IP address.                                                              

See [code](https://github.com/upstash/examples/tree/master/serverless-rate-limiting).

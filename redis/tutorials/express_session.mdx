...
sidebar_label: Express Session with Redis
...
See the [code](https://github.com/upstash/serverless-tutorials/tree/master/express-session-with-redis)
...
Create a database as described [here](../overall/getstarted.md).

### Step-4: index.js
In Upstash console, click the `Connect` button, copy the connection code (Node.js node-redis).
Create index.js file as below and replace the Redis connection part.
``` javascript

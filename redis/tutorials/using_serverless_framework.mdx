---
slug: using_serverless_framework
...
:::note
See [Using AWS SAM](using_aws_sam.md), if you prefer AWS SAM over Serverless Framework.
:::       
...
```shell
➜  test-upstash> serverless invoke -f hello
{
    "response": "bar"
}
```
...
<img src="/img/awslambda/success2.png" width="800" />

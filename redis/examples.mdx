...
<TagFilters>
    ...
    >
        Building a Serverless Notification API for Your Web Application with
        Redis
    </TagFilters.Item>
    <TagFilters.Item
        externalLink
    ...
    <TagFilters.Item
        ...
        type="Article"
        tags={["Next.js", "Vercel"]}
        url="https://docs.upstash.com/redis/tutorials/roadmap_voting"
    >
    ...
    >
        Build your own Waiting Room for your Web site with Cloudflare Workers
        and Serverless Redis
    </TagFilters.Item>
    <TagFilters.Item
        externalLink
        type="Article"
    ...
    >
        Serverless Battleground - DynamoDB vs Firestore vs MongoDB vs Cassandra
        vs Redis vs FaunaDB
    </TagFilters.Item>
    <TagFilters.Item
        externalLink

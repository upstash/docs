...
description: Integrate Upstash into your platform with OAuth 2.0 so users can create and manage Redis, Vector, and QStash databases without leaving your app.
---

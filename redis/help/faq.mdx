...
Free databases are deleted after a minimum of 14 days of inactivity. Pay As You Go databases are deleted after a minimum of 3 months of inactivity. Users get several warning emails prior to deletion.

<Note>
  No data is lost due to deletion. When a database is deleted due to inactivity, we take a backup of the data so users can create a new database and restore their data from the Upstash Console.
</Note>

...
Upstash works for all the common usecases for Redis®. You can use Upstash in your serverless stack. In addition, you can use Upstash as storage (or caching) for your serverless functions. See [Use Cases](../overall/usecases) for more.

## Do you support all Redis® API?

Most of them. See [Redis® API Compatibility](../overall/rediscompatibility) for the list of supported commands.
...
Upstash is serverless. With ElastiCache, you pay even you do not use the database. See [Compare](../overall/compare) for more info.

## How do you compare Upstash with Redis Labs or Compose.io?

Upstash is serverless. With Redis Labs or Compose.io, you always pay a lot when your data size is big but your traffic is low. In Upstash, the pricing is based on per request. See [Compare](../overall/compare) for more info.

...
Free databases are deleted after a minimum of 14 days of inactivity. Pay As You Go databases are deleted after a minimum of 3 months of inactivity. Users get several warning emails prior to deletion. We take a backup of your data so users can create a new database and restore their data to a new database from the Upstash Console.

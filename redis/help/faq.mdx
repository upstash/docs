...
## What happens if I do not use my database?

Free databases are deleted after a minimum of 14 days of inactivity. Pay As You Go databases are deleted after a minimum of 3 months of inactivity. Users get several warning emails prior to deletion. We take backup of your data so users can create a new database and restore it back from Upstash Console.

In addition, Pay as You Go databases are hibernated after a minimum of 2 months of inactivity. Hibernated databases can be restored to active state from Upstash Console.

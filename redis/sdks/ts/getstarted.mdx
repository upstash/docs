...
By default, `@upstash/redis` retries a request 5 times when network errors occur.
You can customize this when creating the client:
...
See [Retries](/redis/sdks/ts/retries) for the exact type definition.

...
<ParamField body="options" type="object">
  Expiration options for the hash fields.
...
<ResponseField type="Record<string, TValue> | null" required>
  An object containing the field names and their values. If all fields are non-existent or the hash doesn't exist, `null` is returned.
</ResponseField>
...
const result = await redis.hgetex("data:xyz", undefined, "field1", "field2");

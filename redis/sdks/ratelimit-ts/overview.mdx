...
<CardGroup cols={2}>
  ...
  <Card
    title="Timeout"
    icon="stopwatch"
    href="https://upstash.com/docs/redis/sdks/ratelimit-ts/features#timeout"
  >
  ...
  <Card
    ...
    href="https://upstash.com/docs/redis/sdks/ratelimit-ts/features#analytics-and-dashboard"
  >
  ...
  <Card
    ...
    icon="lock"
    href="https://upstash.com/docs/redis/sdks/ratelimit-ts/traffic-protection"
  >
  ...
  <Card
    title="Custom Rates"
    icon="chart-simple"
    href="https://upstash.com/docs/redis/sdks/ratelimit-ts/features#custom-rates"
  >
  ...
  <Card
    title="Multi Region"
    icon="globe"
    href="https://upstash.com/docs/redis/sdks/ratelimit-ts/features#multi-region"
  >
  ...
  <Card
    ...
    icon="gears"
    href="https://upstash.com/docs/redis/sdks/ratelimit-ts/features#using-multiple-limits"
  >

...
walkthrough, see [Vercel Eve Sandboxes](/box/guides/eve-setup).
...
<AccordionGroup>
  ...
  <Accordion title="Migrating from upstash() (agentkit-eve 0.12 and earlier)">
    ...
    [migration example](/box/guides/eve-setup#migrating-from-upstash).
  </Accordion>
</AccordionGroup>

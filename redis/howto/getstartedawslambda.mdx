...
<Note>
This example uses Redis clients. If you expect many concurrent AWS Lambda invocation then we recommend using **[upstash-redis](connectwithupstashredis)** which is HTTP/REST based.
</Note>

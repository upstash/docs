...
- **Client networks**: source networks seen by the proxies, masked to /24, attributed to a cloud provider and region when the address belongs to a published AWS, Google Cloud or Cloudflare range, with the entry region they came in through.

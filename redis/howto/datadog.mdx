---
title: Upstash Integration with Datadog
---

Welcome to the Upstash integration with Datadog! This guide will walk you through the steps to seamlessly connect your Datadog account with Upstash for enhanced monitoring and analytics.
...
- This integration can only be execute only one time.If you would like to extend list of the team in integration please re establish the Integration from scratch.

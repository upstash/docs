...
<Frame><img src="/img/vercel/integration_init.png" class="ss" width="520" /></Frame>

If you do not have a Redis database or Kafka cluster yet, you can create one
from the dropdown menu.

<Frame><img src="/img/vercel/integration_redis_create.png" class="ss" width="520" /></Frame>

Once you have selected all resources, click the `Create` button at the bottom of
the page.

<Frame><img src="/img/vercel/integration_filled.png" class="ss" width="520" /></Frame>
...
<Frame><img src="/img/vercel/integration_env.png" class="ss" width="520" /></Frame>
...
ones.
<Frame><img src="/img/vercel/integration_dashboard.png" class="ss" /></Frame>

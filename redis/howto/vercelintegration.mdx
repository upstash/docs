...
<img src="/img/vercel/integration_init.png" class="ss" width="520" />

If you do not have a Redis database or Kafka cluster yet, you can create one
from the dropdown menu.

<img src="/img/vercel/integration_redis_create.png" class="ss" width="520" />

Once you have selected all resources, click the `Create` button at the bottom of
the page.

<img src="/img/vercel/integration_filled.png" class="ss" width="520" />
...
<img src="/img/vercel/integration_env.png" class="ss" width="520" />
...
ones.
<img src="/img/vercel/integration_dashboard.png" class="ss" />

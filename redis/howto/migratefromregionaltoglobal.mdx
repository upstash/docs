...
We strongly recommend you to use [Upstash Redis Global](https://upstash.com/docs/redis/global-redis) for your application.
...
2. Export data from regional database:
   ```bash
   upstash-redis-dump -db 0 -host YOUR_REGIONAL_HOST -port 6379 -pass YOUR_PASSWORD -tls > redis.dump
   ```

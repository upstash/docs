...
<Frame><img src="/img/durability/storage.png" width="600" /></Frame>
...
server crashes. This is not the case for Upstash thanks to Durable Storage. Data
is reloaded to memory from block storage in case of a server crash. Moreover,
the highly available Premium database provides extra redundancy by replicating
data to multiple instances.
</Card>

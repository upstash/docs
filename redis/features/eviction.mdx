...
- You can enable eviction by checking **Eviction** checkbox while creating a new
  ...
  <Frame>
    <img src="/img/eviction/create-database.png" alt="Enable eviction when creating a Redis database" />
  </Frame>

- Or for an existing database by clicking **Enable** in Configuration/Eviction
  box in the database details page:
  <Frame>
    <img src="/img/eviction/configuration.png" alt="Manage Redis eviction in the Upstash Console" />
  </Frame>

...
<Frame>
  <img src="/img/backuprestore/backup-export-button.png" alt="Export a Redis backup" width="800" />
</Frame>
...
<Frame>
  <img src="/img/backuprestore/daily-backup-toggle.png" alt="Enable daily Redis backups" width="800" />
</Frame>
...
<Frame>
  <img src="/img/backuprestore/restore-from-table.png" alt="Select a Redis backup to restore" width="800" />
</Frame>
...
<Frame>
  <img src="/img/backuprestore/restore-modal.png" alt="Confirm a Redis backup restore" width="700" />
</Frame>

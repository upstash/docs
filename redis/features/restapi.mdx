...
REST API returns a JSON response. When command execution is successful, response
...
In case when transaction is succesful, multiple responses corresponding to each
...
<Frame><img src="/img/restapi/tokens.png" /></Frame>
...
<Frame><img src="/img/restapi/acl-resttoken.png" /></Frame>
...
our [pricing](../overall/pricing) applies to your REST calls too.

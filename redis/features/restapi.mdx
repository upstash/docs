...
If you want to get the raw response as base64, you can set the `Upstash-Encoding`
header to `base64` and the strings in the response will be base64 encoded with 
the exception of the "OK" response.

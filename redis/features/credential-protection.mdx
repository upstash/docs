...
description: Credential Protection keeps Upstash Redis database credentials out of Upstash infrastructure, exposing them only once at generation for stronger security.
---

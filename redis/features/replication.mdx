---
title: Replication
description: How Upstash Redis replication uses primary and read replicas to deliver high availability, better scalability, and multi-zone resilience.
---

---
title: Auto Upgrade
description: Auto Upgrade automatically moves your Upstash Redis database to a higher plan when you hit bandwidth or storage limits, preventing throttling and downtime.
---

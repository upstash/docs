...
- You can enable Auto Upgrade by checking the Auto Upgrade checkbox while creating a new database:
  ...
  <Frame>
    <img src="/img/auto-upgrade/create-database.png" alt="Enable Auto Upgrade when creating a Redis database" width="%50" />
  </Frame>

- Or for an existing database by clicking Enable in the Configuration/Auto Upgrade box in the database details page:
  <Frame>
    <img src="/img/auto-upgrade/configuration.png" alt="Manage Auto Upgrade in the Upstash Console" width="600" height="300" />
  </Frame>

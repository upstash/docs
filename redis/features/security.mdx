...
<Warning>
As of May 2024, the ACL command is no longer supported for newly created databases on the AWS platform. 
However, it remains available on [fly.io](https://fly.io/docs/reference/redis/), GCP, and AWS databases created before May 2024.
</Warning>

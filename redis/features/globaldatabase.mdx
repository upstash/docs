...
description: Upstash Redis Global Database replicates data across multiple regions with a primary and read regions to deliver low read latency worldwide.
---

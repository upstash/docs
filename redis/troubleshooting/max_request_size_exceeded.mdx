...
You can upgrade your database to Pro/Enterprise as it has higher limits. Also you can submit quota increase request in the console or you can contact support@upstash.com about the options with higher max request size limit.

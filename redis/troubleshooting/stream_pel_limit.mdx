...
[XACK](/redis/commands/streams/xack). This list is populated via
[XREADGROUP](/redis/commands/streams/xreadgroup).

### Solution

Acknowledge the consumed messages via [XACK](/redis/commands/streams/xack)

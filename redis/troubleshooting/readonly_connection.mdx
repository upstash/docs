...
description: Connect to Upstash Redis with a read-only token over TCP using the default_ro user or a custom read-only ACL user to avoid WRONGPASS errors.
---

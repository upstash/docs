...
<Note> 
This solution may have a latency overhead (about 4 ms). See [the blog post](https://blog.upstash.com/serverless-database-connections) for
more.
</Note>
...
<Info>
    See [the blog post](https://blog.upstash.com/serverless-database-connections) about the

...
<Frame>
  <img src="/img/cloudflare-integration/redis-secrets.png" alt="Redis secrets in Cloudflare Workers" />
</Frame>
...
<Frame>
  <img src="/img/cloudflare-integration/redis-secrets-store.png" alt="Cloudflare Workers secrets store for Redis" />
</Frame>

- Under **Compute (Workers)** > **Workers & Pages**, find your worker and add these secrets as bindings.

<Frame>
  <img src="/img/cloudflare-integration/redis-add-binding.png" alt="Add a Redis binding to a Cloudflare Worker" />
</Frame>

...
[Upstash CLI](https://github.com/upstash/cli). Select the database type as global to minimize the
...
We will also install the **Upstash Redis SDK** to connect to Redis database over HTTP.

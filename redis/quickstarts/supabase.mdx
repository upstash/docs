...
slug: "/redis/quickstarts/supabase"
---
   

The below is an example for a Redis counter that stores a [hash](https://redis.io/commands/hincrby/) of Supabase function invocation count per region.

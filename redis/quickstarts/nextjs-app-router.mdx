...
1. Grab your Redis credentials from the Upstash dashboard
   ...
   <Frame>
     <img src="/img/next-quickstart/credentials.png" alt="Redis credentials for a Next.js application" />
   </Frame>
...
<Frame>
  <img src="/img/next-quickstart/curl.png" alt="Redis REST API request with curl" />
</Frame>

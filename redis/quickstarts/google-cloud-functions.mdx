...
<Frame>
  <img src="/img/redis-gcloud/create-service.png" alt="Create a Google Cloud Run function" />
</Frame>
...
<Frame>
  <img src="/img/redis-gcloud/env-variables.png" alt="Redis environment variables in Google Cloud Run" />
</Frame>
...
<Frame>
  <img src="/img/redis-gcloud/entry-point.png" alt="Set the Google Cloud Run function entry point" />
</Frame>

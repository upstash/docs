...
:::info
You can also integrate your Vercel projects with Upstash using Vercel Integration module. Check [this article](../howto/vercelintegration.md). 
:::

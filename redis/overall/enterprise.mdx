...
<Note>
    The above pricing assumes that the clients and database are in the same
    cloud provider. If not, you may be charged at a higher rate proportional to
    what cloud providers charge us. Contact us
    [support@upstash.com](mailto:support@upstash.com) for details.
</Note>

...
<Frame>
  <img src="/img/getting_started/create-global.png" alt="Create a Global Redis database" />
</Frame>
...
<Frame>
  <img src="/img/getting_started/database.png" alt="Redis database details in the Upstash Console" width="100%" />
</Frame>
...
<Tip>
  You can copy the `redis-cli` command to connect to your database from the **Details** tab of your database in the Upstash Console. The **Token** shown there is also your database's password.
</Tip>
...
```bash
> redis-cli --tls -a YOUR_TOKEN -h YOUR_ENDPOINT -p YOUR_PORT
YOUR_ENDPOINT:YOUR_PORT> set counter 0
OK
YOUR_ENDPOINT:YOUR_PORT> get counter
"0"
YOUR_ENDPOINT:YOUR_PORT> incr counter
(int) 1
YOUR_ENDPOINT:YOUR_PORT> incr counter
(int) 2
```

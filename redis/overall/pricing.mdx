...
| Encryption at REST |  ❌  |  ❌  |  ✅                                                                       | Last 1 year |
...
credit card, your database will be upgraded to pay-as-you-go automatically. You
need to contact us to upgrade a database to a pro/enterprise plan.  
:::
...
:::note
The total storage is the sum of storage in all replicas. So 1 MB data will total
up to 2 MB because data is replicated to multiple instances.
:::
...
*Pay as you go* plan has limits which are introduced to ensure the fair use of
...
:::note
Quotas are not technical limits. They can be customized on your request. You can
submit contact us (support@upstash.com) if you think your application needs
higher limits.
:::
...
All limits are per a database. If you think, your use case will exceed the above
quotas, check our [Pro/Enterprise Plans](#enterprise-plan) where the limits are
higher.

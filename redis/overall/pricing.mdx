...
| Enterprise | Custom | - | 10TB | Unlimited |           Custom |            500MB |        5GB |          100000 |
...
Professional support includes a dedicated service desk along and a Slack/Discord channel with a committed response time SLA. Check [Professional Support](https://upstash.com/docs/common/help/prosupport) for details.

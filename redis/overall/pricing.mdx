...
For fixed plans, bandwidth is included in the price up to your plan's limit. If your database is on the highest fixed tier and exceeds its bandwidth allowance, we will reach out with upgrade and enterprise plan options. If you do not respond to these communications, we reserve the right to charge bandwidth overages at our cost rate from the cloud provider (e.g., AWS data transfer fees).

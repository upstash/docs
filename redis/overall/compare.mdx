...
option to purchase Pro/Enterprise Plan. In Enterprise plan you can set fixed
price per month with a restriction on max throughput and data size. For high and
steady throughput use cases, enteprise databases cost less than serverless one.
The good thing is you can start your database with pay-as-you-go pricing and
move it enterprise when you want. See [enterprise plans](enterprise) for more
information.

Even if you choose not to upgrade to the Pro/Enterprise plan, Upstash guarantees
...
pay-as-you-go (PAYG) databases, this ceiling price is set at $160 per month.
...
exceed a maximum cost of $160 per month.

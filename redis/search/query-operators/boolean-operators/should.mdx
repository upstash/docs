---
title: $should
description: Match at least one condition as a logical OR, or boost scores when combined with $must, using the $should boolean operator in Upstash Redis Search.
---

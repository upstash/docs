---
title: $fuzzy
description: Match terms that are similar but not identical using Levenshtein distance to handle typos and misspellings with the $fuzzy operator in Upstash Redis Search.
---

---
title: $boost
description: Adjust the relevance score contribution of a field match to prioritize certain matches in result ranking with the $boost operator in Upstash Redis Search.
---

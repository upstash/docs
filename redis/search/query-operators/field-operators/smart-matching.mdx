...
description: Understand default smart matching, which applies exact checks on numeric fields and intelligent multi-stage matching on text fields in Upstash Redis Search.
---

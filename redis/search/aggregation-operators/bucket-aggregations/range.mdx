---
title: $range
description: Group documents into custom from/to range buckets with the $range aggregation for pricing tiers and business-logic ranges in Upstash Redis Search.
---

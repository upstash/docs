---
title: $facet
description: Build hierarchical bucket trees from FACET field paths with the $facet aggregation for drill-down category navigation in Upstash Redis Search.
---

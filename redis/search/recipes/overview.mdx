---
title: Overview
description: Real-world Upstash Redis Search recipes for e-commerce, blog, and user directory search, each with schema design, sample data, and query patterns.
---

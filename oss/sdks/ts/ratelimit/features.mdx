...
`ip1`, the request will be denied without having to call Redis.
...
See the section on how caching impacts the cost in the [costs page](https://upstash.com/docs/oss/sdks/ts/ratelimit/costs#cache-result).
...
and how many were received in total. Additionally, you can see requests over time, top allowed and
blocked requests.

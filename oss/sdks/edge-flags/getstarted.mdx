...
Go to [console.upstash.com/edge-flags](https://console.upstash.com/edge-flags)
and select the database you created in the previous step. Create a new flag and
enable it. Then you can add some rules.

![Created](/img/edge-flags/created.png)
...
For more information about client side usage, see [here](/redis/sdks/edge-flags/react).

...
<Tip>
  If you wanna learn more about filtering check: [Metadata
  Filtering](https://upstash.com/docs/vector/features/filtering)
</Tip>
...
It's also possible to specify a namespace when querying vectors:

...
Removal of GraphQL API and edge caching (Redis) (October 1, 2022)
These two features have been already deprecated. We are planning to deactivate them completely on November 1st.  We recommend use of REST API to replace GraphQL API and Global databases instead of Edge caching.

Removal of strong consistency (Redis) (October 1, 2022) 
...
Kafka Support is released. Check the [the blog post](https://blog.upstash.com/serverless-kafka-launch).
...
Google Cloud is available for Upstash Redis databases. We initially support US-Central-1 (Iowa) region. Check the [get started guide](https://docs.upstash.com/redis/howto/getstartedgooglecloudfunctions).
...
Click [here](https://roadmap.upstash.com) to request new regions to be supported.
...
See [how to guide](https://docs.upstash.com/redis/howto/vercelintegration.md).

See [integration page](https://vercel.com/integrations/upstash).

See [Roadmap Voting app](https://github.com/upstash/serverless-tutorials/tree/master/roadmap-voting-app) as a showcase for the integration.

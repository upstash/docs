...
You can delete your credit card from `Account` > `Billing` page. You can also delete the last card on the account. When you do, the console asks you to confirm, because your existing resources are restored to the free plan quotas. If you want to delete all of your payment information, you should delete your account.

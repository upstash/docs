...
In our Pay as You Go model, you have the flexibility to set budgets at either the account level or for individual Redis and Kafka instances. When your monthly costs approach your maximum budget, we'll notify you via email. To prevent exceeding your set budget, we'll then throttle your instance's performance. Rest assured, you will never be charged more than the budget you've specified.

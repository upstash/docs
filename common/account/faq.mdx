...
You can delete your credit card from `Account` > `Billing` page. You can also delete the last card on the account. When you do, the console asks you to confirm, because your existing resources are restored to the free plan quotas and usage above those limits is rejected. Outstanding charges are still invoiced, and you can add a new card at any time to move back to a paid plan. If you want to delete all of your payment information, you should delete your account.

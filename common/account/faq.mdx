...
On Pay as You Go model, you can set a budget for your Redis and Kafka instances. When your monthly cost reaches the max budget, we send an email to inform you and throttle your database. You will not be charged beyond your set budget.

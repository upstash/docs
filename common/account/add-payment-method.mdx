...
<Frame>
  <img src="/img/addpaymentmethod/ccform.png" alt="Add a Payment Method: Credit card form" />
</Frame>

You can save multiple cards and pick one as the default. Payments are charged from the default card.

<Frame>
  <img src="/img/addpaymentmethod/cardlist.png" alt="Add a Payment Method: Saved payment methods" />
</Frame>

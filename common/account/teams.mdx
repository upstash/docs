...
Team management enables collaboration with other users. You can create a team and invite people to join by using their email addresses. Team members will have access to the resources created under the team — Redis databases, QStash topics, Vector indexes and other product resources — based on their assigned roles.

<Frame>
  <img src="/img/teams/team-member.png" alt="Team member list in the Upstash Console" />
</Frame>
...
<Frame>
  <img src="/img/teams/team-page.png" alt="Teams page in the Upstash Console" />
</Frame>
<br />
<Frame>
  <img src="/img/teams/team-create.png" alt="Create team form in the Upstash Console" />
</Frame>
...
> The resources in your personal account are not shared with anyone. If you want
> a database, index or topic to be accessible by other users, you need to create
> it under a team.
...
<Frame>
  <img src="/img/teams/change-team.png" alt="Team selector in the Upstash Console" />
</Frame>
...
<Frame>
  <img src="/img/teams/team-member-create.png" alt="Invite team member form in the Upstash Console" />
</Frame>

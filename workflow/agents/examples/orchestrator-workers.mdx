...
<img src="/img/workflow/agents/orchestrator-diagram.png" />
...
If you wish to manually use the model results instead of utilizing a [manager LLM](/workflow/agents/overview#multi-agents) as we did in this example, see the [parallelization example](/workflow/agents/examples/parallelization)

<img src="/img/workflow/agents/orchestrator-workers.png" />

...
description: Build an orchestrator-workers agent pattern with Upstash Workflow, directing multiple worker agents on subtasks and synthesizing their outputs.
---

...
<img src="/img/workflow/agents/diagram/orchestrator-diagram.png" alt="Orchestrator-workers workflow diagram" />
...
<img src="/img/workflow/agents/logs/logs-manager.png" alt="Orchestrator manager workflow logs" />

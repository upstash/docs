...
Your workflow runs will appear in the dashboard, where you can monitor and debug them.
...
<Tip>
  When preparing your app for production, you will update these values with your production credentials from the Upstash Workflow dashboard.
</Tip>

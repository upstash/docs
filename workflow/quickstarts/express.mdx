...
<Note>
  It's perfectly okay to use your QStash acoount information at this point, but you can also run a local development server and use during the development and testing phase.
  Check out our [local development guide](/workflow/howto/local-development) for more information.
</Note>

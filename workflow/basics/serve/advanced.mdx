...
<ParamField path="redact" type="object">
    ...
    <Expandable title="properties">
        ...
        <ParamField body="header" type="true | list[str]" optional>
            Controls header redaction:
            - `True`: Redact all headers
            - List of strings: Redact only the specified headers (e.g., `["Authorization", "X-API-Key"]`)
        </ParamField>
    </Expandable>

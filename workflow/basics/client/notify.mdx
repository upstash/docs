...
Workflows paused at a [`context.waitForEvent`](/workflow/basics/context#context-waitforevent) step with the matching `eventId` will be resumed, and the provided `eventData` will be passed back to them.

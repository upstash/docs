...
Note that if you are using a [custom authorization method](/workflow/howto/security#custom-authorization-method), you should also add authentication to `failureFunction`.

...
description: Build a customer onboarding workflow with Upstash Workflow that registers users, sends welcome emails, and reacts to user activity over time.
---

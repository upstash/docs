...
<Tabs>
  <Tab title="Runs">
    <Frame>
      <img src="/img/qstash-workflow/run-view.png" alt="Workflow run inspector" />
    </Frame>
  </Tab>
  <Tab title="DLQ">
    <Frame>
      <img src="/img/qstash-workflow/workflow_dlq.png" alt="Workflow dead-letter queue" />
    </Frame>
  </Tab>
  <Tab title="Schedules">
    <Frame>
      <img src="/img/qstash-workflow/create_schedule.png" alt="Workflow schedules" />
    </Frame>
  </Tab>
</Tabs>

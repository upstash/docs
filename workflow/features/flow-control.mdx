...
<Frame caption="Workflow simplified by step types">
  <img src="/img/workflow/flow_control_ex_3.png" alt="Flow-controlled workflow step types" />
</Frame>
...
<Frame caption="Steps are enqueued for execution">
  <img src="/img/workflow/flow_control_ex_2.png" alt="Workflow steps queued for execution" />
</Frame>
...
<Frame caption="Parallelism waitlist for the flow-control">
  <img src="/img/workflow/flow_control_ex_1.png" alt="Workflow parallelism waitlist" />
</Frame>

...
<Frame caption="A failing step is automatically retried three times">
  <img src="/img/workflow/parallelism_1.png" alt="Workflow steps within the parallelism limit" />
</Frame>

When all tokens are in use, additional requests are not failed — they’re queued in a **waitlist**:
<Frame caption="A failing step is automatically retried three times">
  <img src="/img/workflow/parallelism_2.png" alt="Workflow step waiting at the parallelism limit" />
</Frame>
...
<Frame caption="A failing step is automatically retried three times">
  <img src="/img/workflow/parallelism_3.png" alt="Workflow step starts when capacity is available" />
</Frame>

...
<Frame caption="You can filter DLQ entries by failure function state">
  <img src="/img/workflow/failure_callback_state_filter.png" alt="Filter DLQ entries by failure function state" />
</Frame>

From the DLQ dashboard, you can retry the failure function.

<Frame caption="You can filter DLQ entries by failure function state">
  <img src="/img/workflow/retry_failure_callback.png" alt="Retry a failed workflow callback" />
</Frame>

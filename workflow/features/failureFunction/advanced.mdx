...
description: Use the failureUrl option to send Upstash Workflow failure callbacks to a separate endpoint, handling failures on infrastructure independent of your workflow.
---

---
title: "Sleep"
description: Pause Upstash Workflow execution with context.sleep and sleepUntil to build time-based delays without consuming compute or serverless timeouts.
---

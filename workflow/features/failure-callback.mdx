---
title: "Overview"
description: Attach a failure function to your Upstash Workflow to run custom cleanup, logging, or alerting when a run fails after exhausting all retries.
---

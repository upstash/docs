---
title: "Restart"
description: Restart a failed Upstash Workflow run from the beginning, discarding previous step results and executing from scratch with the original payload.
---

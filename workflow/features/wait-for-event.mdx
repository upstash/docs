---
title: "Overview"
description: Pause an Upstash Workflow with waitForEvent until an external event arrives, with timeouts and lookback strategies to avoid notify race conditions.
---

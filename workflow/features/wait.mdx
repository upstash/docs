---
title: "Wait"
description: Pause an Upstash Workflow run with waitForEvent until a matching event is published, using configurable timeouts to handle waits gracefully.
---

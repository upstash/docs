---
title: "Webhooks"
description: Pause an Upstash Workflow and wait for a callback URL with createWebhook and waitForWebhook, integrating third-party APIs with built-in lookback.
---

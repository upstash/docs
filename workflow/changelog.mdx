---
title: Changelog
description: Changelog for Upstash Workflow, tracking new features and updates to the TypeScript (workflow-js) and Python (workflow-py) SDKs.
---
...
- Added [Wait Notify](/workflow/features/wait-for-event) feature.
</Update>

...
<Frame>
  <img src="/img/qstash-workflow/create_schedule.png" alt="Create a Workflow schedule" />
</Frame>
...
<Frame>
  <img src="/img/qstash-workflow/schedule_workflow.png" alt="Scheduled Workflow run" />
</Frame>

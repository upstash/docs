---
title: "Limit Rate and Parallelism with Flow Control"
---

`Flow Control` enables you to limit the number of calls made to your workflow via delaying the delivery. 
...
For more details, see the documentation of related `serve` parameters, see [Rate Per Second](/workflow/basics/serve#ratePerSecond) and [Parallelism](/workflow/basics/serve#parallelism).  
...
For more detailso `trigger`, see the documentation [here](https://upstash.com/docs/workflow/basics/client#trigger-workflow).  

...
<Tabs>
    <Tab title="macOS">
        <Frame>
          <img src="/img/qstash-workflow/ngrok_mac_setup.png" alt="Configure an ngrok tunnel on macOS" />
        </Frame>
    </Tab>

    <Tab title="Windows">
        <Frame>
          <img src="/img/qstash-workflow/ngrok_windows_setup.png" alt="Configure an ngrok tunnel on Windows" />
        </Frame>
    </Tab>
</Tabs>

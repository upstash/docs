...
<CardGroup cols={2}>
    <Card title="Serverless" href="/common/concepts/serverless">
        Upstash is serverless. You don't need to provision any infrastructure.
        Just create a database and start using it.
    </Card>
    <Card title="Scaling to Zero" href="/common/concepts/scale-to-zero">

...
<Frame>
  <img src="/img/cloudflare-integration/secrets.png" alt="QStash secrets in Cloudflare Workers" />
</Frame>
...
<Frame>
  <img src="/img/cloudflare-integration/secrets-store.png" alt="Cloudflare Workers secrets store" />
</Frame>

- Under **Compute (Workers)** > **Workers & Pages**, find your worker and add these secrets as bindings.

<Frame>
  <img src="/img/cloudflare-integration/add-binding.png" alt="Add a QStash binding to a Cloudflare Worker" />
</Frame>

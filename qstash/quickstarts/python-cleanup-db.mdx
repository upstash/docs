---
title: "Python Cleanup DB Cron job"
---
...
<Steps>
  ...
  <Step titleSize="h3"  title="Make the Python code into a public endpoint">
    ...
    redis = Redis(url="https://YOUR_REDIS_URL", token="AYbVASQgMmYwOGNjNjEtYzI2MS00ZGY0LWE4NjUtYjQ4NDkwMjgwZWYzOWM1MTRhZWExYjI5NGZlYThkMTgxZmMxYmY4MzE4MDU=")
...
[callbacks](/qstash/features/callbacks) and [topics](/qstash/features/topics).
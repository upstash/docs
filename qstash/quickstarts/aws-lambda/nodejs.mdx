...
<Frame>
<img src="/img/qstash/aws/api-gateway.png" alt="API Gateway trigger for the Lambda function" />
</Frame>
...
<Frame>
  <img src="/img/qstash-workflow/qstash_signing_keys.png" alt="QStash signing keys in the Upstash Console" />
</Frame>

and make these two variables available to your Lambda in your function configuration:

<Frame>
<img src="/img/qstash/aws/environment.png" alt="QStash environment variables for the Lambda function" />
</Frame>
...
<Frame>
<img src="/img/qstash/aws/create_lambda.png" alt="Create an AWS Lambda function" />
</Frame>

2. To make this Lambda available under a public URL, navigate to the `Configuration` tab and click `Function URL`:

<Frame>
<img src="/img/qstash/aws/create_url.png" alt="Create a Lambda function URL" />
</Frame>
...
<Frame>
<img src="/img/qstash/aws/overview.png" alt="AWS Lambda (Node): Manual Deployment" />
</Frame>
...
<Frame>
<img src="/img/qstash/aws/upload.png" alt="Upload the Lambda deployment package" />
</Frame>
...
<Frame>
<img src="/img/qstash/aws/verify-integration.png" alt="Successful QStash and Lambda integration" />
</Frame>

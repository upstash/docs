...
<Frame>
  <img src="/img/qstash/aws/python/create_lambda.png" alt="Create a Python AWS Lambda function" />
</Frame>
...
<Frame>
  <img src="/img/qstash/aws/python/overview.png" alt="AWS Lambda (Python): 4. Create a Lambda function on AWS" />
</Frame>

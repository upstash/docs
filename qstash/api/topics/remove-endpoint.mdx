...
```js Node
fetch("https://qstash.upstash.io/v2/topics/:topicName/endpoints", {
  method: "DELETE",
  headers: {
...
response = requests.delete('https://qstash.upstash.io/v2/topics/:topicName/endpoints', headers=headers, data=data)
```

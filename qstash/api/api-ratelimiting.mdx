...
This is a short-term limit to prevent rapid bursts of requests.

**Headers**:

- `Burst-RateLimit-Limit`: Maximum number of requests allowed in the burst window
- `Burst-RateLimit-Remaining`: Remaining number of requests in the burst window

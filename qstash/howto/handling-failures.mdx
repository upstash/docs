...
Once you handle the failure, you can [delete it from the dead letter queue](/qstash/api-refence/dlq/delete-a-dlq-message).
...
via the [REST API](/qstash/api-refence/dlq/retry-a-dlq-message).

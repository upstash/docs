...
description: Share a QStash read-only token with teammates or AI agents to view logs, messages, and schedules without allowing publishing or resource changes.
---

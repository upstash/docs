---
title: "Reset Token"
description: Reset your QStash token from the console to invalidate the current one, then update it across your applications to keep publishing messages.
---

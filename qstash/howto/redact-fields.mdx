...
<Frame caption="Logs of a message with `body` and header[My-Secret-Header] redacted">
  <img src="/img/qstash/redact-logs.png" alt="Logs of a message with body and header[My-Secret-Header] redacted" />
</Frame>
...
<Frame caption="Schedule with body and header[My-Secret-Header] redacted">
  <img src="/img/qstash/redact-schedules.png" alt="Schedule with body and header[My-Secret-Header] redacted" />
</Frame>

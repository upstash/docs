...
<Card title="GitHub Repository" icon="github" href="https://github.com/upstash/qstash-js/tree/main/examples/workflow/nuxt" horizontal>
  You can find the project source code on GitHub.
</Card>
This guide provides detailed, step-by-step instructions on how to use and deploy Upstash Workflow with Nuxt.js. You can also explore our [Nuxt example](https://github.com/upstash/qstash-js/tree/main/examples/workflow/nuxt) for a detailed, end-to-end example and best practices.

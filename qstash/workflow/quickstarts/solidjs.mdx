...
This guide provides detailed, step-by-step instructions on how to use and deploy Upstash Workflows with SolidJS. You can also explore our [SolidJS example](https://github.com/upstash/qstash-js/tree/main/examples/workflow/solidjs) for a detailed, end-to-end example and best practices.

## Step 1: Installation

First, install the QStash SDK in your SolidJS project:
...
2. Explore our [SolidJS example](https://github.com/upstash/qstash-js/tree/main/examples/workflow/solidjs) for a detailed, end-to-end example and best practices.

3. For setting up and testing your workflows in a local environment, check out our [local development guide](/qstash/workflows/howto/local-development).

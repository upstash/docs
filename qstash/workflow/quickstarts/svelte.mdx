...
<Card title="GitHub Repository" icon="github" href="https://github.com/upstash/qstash-js/tree/main/examples/workflow/sveltekit" horizontal>
  You can find the project source code on GitHub.
</Card>
This guide provides detailed, step-by-step instructions on how to use and deploy Upstash Workflow with SvelteKit. You can also explore our [SvelteKit example](https://github.com/upstash/qstash-js/tree/main/examples/workflow/sveltekit) for a detailed, end-to-end example and best practices.
...
First, install the QStash SDK in your SvelteKit project:
...
2. Explore our [SvelteKit example](https://github.com/upstash/qstash-js/tree/main/examples/workflow/sveltekit) for a detailed, end-to-end example and best practices.

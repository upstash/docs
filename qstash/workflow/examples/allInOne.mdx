...
HTTP calls to third-party services are non-blocking and do not consume the endpoint's execution time when using [context.call](/qstash/workflow/basics/context#context-call).
...
[Sleeps](/qstash/workflow/basics/context#context-sleep) also do not consume the endpoint's execution time, allowing you to efficiently manage delays.

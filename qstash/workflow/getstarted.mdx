...
<Tip>
  Any HTTP request using `context.call` does not count towards your function's execution time (and increase your
  serverless bill). It can also run for up to 2 hours, completely bypassing any platform-specific function timeouts.
</Tip>

...
Setting this environment variable is especially useful during [local development](/qstash/workflows/howto/local-development). In production, `baseUrl` or `UPSTASH_WORKFLOW_URL` are not necessary.

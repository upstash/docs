...
HTTP calls to third-party services are non-blocking and do not consume the endpoint's execution time when using [context.call](/qstash/workflows/basics/context#context-call).
...
[Sleeps](/qstash/workflows/basics/context#context-sleep) also do not consume the endpoint's execution time, allowing you to efficiently manage delays.

...
This guide provides detailed, step-by-step instructions on how to use and deploy Upstash Workflows with Nuxt.js. You can also explore our [Nuxt example](https://github.com/upstash/qstash-js/tree/main/examples/workflow/nuxt) for a detailed, end-to-end example and best practices.

## Step 1: Installation

First, install the QStash SDK in your Nuxt project:
...
Once you have a live URL for your local workflow endpoint, trigger your workflow by first starting your Nuxt app:
...
When deploying your Nuxt.js application with Upstash Workflows to production, there are a few key points to keep in mind:
...
2. Explore our [Nuxt example](https://github.com/upstash/qstash-js/tree/main/examples/workflow/nuxt) for a detailed, end-to-end example and best practices.

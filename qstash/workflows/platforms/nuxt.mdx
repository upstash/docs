...
On this page, we explain how to use Upstash Workflow with Nuxt.

You can find [a complete Nuxt example in the sdk repository](https://github.com/upstash/qstash-js/tree/main/examples/workflow/nuxt).


# 1. Setting up Your Project

First, you should start a project. You can learn more about [starting a SolidJS project in SolidJS documentation](https://nuxt.com/docs/getting-started/installation).

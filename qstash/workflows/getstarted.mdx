...
```bash 
curl -X POST -d signin-app.vercel.app -d '{"userId": 42, "question" : "what is the meaning of life?" }'
```
...
- [log](/qstash/workflows/howto/logging) what is running correctly
...
- handle [workflow sdk version changes](/qstash/workflows/howto/version#sdk-version) or changes on [your application code]

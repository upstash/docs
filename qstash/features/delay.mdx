---
title: "Delay"
description: Delay QStash message delivery with relative Upstash-Delay or absolute Upstash-Not-Before headers, plus how delays apply to scheduled messages.
---

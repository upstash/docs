...
<Warning title="Max HTTP Timeout">
QStash will abort a delivery attempt if **the HTTP call to your endpoint does not return within the plan-specific Max HTTP Timeout**.  

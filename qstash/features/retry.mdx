...
<Warning title="Max HTTP Connection Timeout">
QStash will abort a delivery attempt if it cannot establish an **HTTP connection to your endpoint within the plan-specific Max HTTP Connection Timeout**.  

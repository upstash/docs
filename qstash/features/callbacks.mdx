...
<img className="block h-32 dark:hidden" src="/img/qstash/callbacks.png" alt="QStash callback flow" />
<img className="hidden h-40 dark:block" src="/img/qstash/callback_dark.png" alt="QStash callback flow" />

---
title: "Callbacks"
description: Use QStash callbacks and failure callbacks to handle responses from long-running endpoints without waiting, bypassing serverless execution time limits.
---

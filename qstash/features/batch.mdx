---
title: "Batching"
description: Send multiple QStash messages in a single request with the batch endpoint, targeting destinations, URL Groups, and queues with custom headers and bodies.
---

---
title: "Security"
description: Authorize QStash API requests with your token and verify incoming messages using the Upstash-Signature JWT header to secure your endpoints.
---

...
<Card title="Workflows(New)" href="/qstash/workflows/getstarted" >

Workflows are Qstash simplified for your complex applications.

- You can skip details of publishing/enqueing 

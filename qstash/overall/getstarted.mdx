...
<Tip href="/qstash/workflows/getstarted" >

We have a new addition to SDK called [Workflows](/qstash/workflows/getstarted).

It is **Qstash** simplified for your complex applications

- TODO work on this introduction more. 

- You can skip details of publishing.

- Get benefit of all Qstash like automatic retries, delivery guarantee...

- And be free of platform specific timeouts.

Check out [Workflows Getting Started](/qstash/workflows/getstarted) for more
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/qstash/features/queues#controlled-parallelism"
  >
  ...
  <Card
    ...
    icon="shapes"
    href="/qstash/features/llm#integrations-with-qstash-apis"
  >

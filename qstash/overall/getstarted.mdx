...
<CardGroup cols={2}>
  ...
  <Card title="Topics" icon="arrow-up-to-dotted-line" href='/qstash/features/topics'>
    Publish messages to multiple endpoints, in parallel
  </Card>
...
<CardGroup cols={2}>
  <Card title="Next.js" icon="node-js" href='/'>
    Build a Next application that uses QStash to send an email when a user signs up to your platform
  </Card>

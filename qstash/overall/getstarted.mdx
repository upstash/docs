...
<CardGroup cols={2}>
  ...
  <Card title="Parallelism" icon="arrows-up-to-line" href='/qstash/features/queues#controlled-parallelism'>
    Controlled parallelism to avoid overflowing your endpoint without compramising throughput.
  </Card>
  ...
  <Card title="Chat Completions" icon="message" href="/qstash/features/chat-completions">
    Generate responses for one or more chat messages using large language models
  </Card>
  <Card title="Chat Completion Integrations" icon="shapes" href="/qstash/features/chat-completions#integrations-with-qstash-apis">
    Publish, enqueue, or batch chat completion requests with QStash features.
  </Card>
</CardGroup>

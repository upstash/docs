...
<CardGroup cols={2}>
  <Card title="Background Jobs" icon="share-all" href='/'>
    Run long-running tasks in the background, without blocking your application.
  </Card>
  <Card title="Scheduling" icon="calendar-days" href='/'>
    Schedule messages to be delivered at a time in the future.
  </Card>
  <Card title="Topics" icon="arrow-up-to-dotted-line" href='/'>
    Publish messages in parallel to multiple endpoints.
  </Card>
  <Card title="Callbacks" icon="phone" href='/'>
   Get a response delivered to your API when a message is delivered.
  </Card>
  <Card title="Retry Failed Jobs" icon="repeat" href='/'>
    Use a Dead Letter Queue to have full control over failed messages.
  </Card>
  <Card title="Deduplication" icon="copy" href='/'>
...
<CardGroup cols={2}>
  <Card title="Next.js" icon="node-js" href='/'>
    Build a Next application that uses QStash to send an email when a user signs up.
  </Card>
  <Card title="Python" icon="python" href='/'>
    Build a Python application that uses QStash to send a message to a Slack channel.
  </Card>
</CardGroup>

Or continue reading to learn how to send your first message without any code!

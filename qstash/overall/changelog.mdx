---
title: Changelog
description: Track new QStash features and updates across the server, console, and TypeScript and Python SDKs over time.
---
...
- Added [ability to configure](/qstash/features/callbacks#configuring-callbacks) callbacks(/failure_callbacks)

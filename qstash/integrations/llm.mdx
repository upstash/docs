---
title: "LLM - OpenAI"
description: Call OpenAI and OpenAI-compatible LLM APIs through QStash to publish, enqueue, and batch chat completions with retries, callbacks, and 2-hour timeouts.

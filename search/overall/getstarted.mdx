...
<Frame style={{ width: "600px" }}>
  <img src="/img/search/create-database.png" alt="Create a Search database" />
</Frame>
...
<Frame style={{ width: "600px" }}>
  <img src="/img/search/database-created.png" alt="New Search database in the Upstash Console" />
</Frame>
...
<Frame style={{ width: "600px" }}>
  <img src="/img/search/add-data.png" alt="Add data to a Search database" />
</Frame>

A dialog with the following options will open:

<Frame style={{ width: "600px" }}>
  <img src="/img/search/add-document.png" alt="Add a document to a Search database" />
</Frame>
...
<Frame style={{ width: "600px" }}>
  <img src="/img/search/first-search.png" alt="Run the first Search query" />
</Frame>

...
description: "A quick guideline to crawl docs and create a functional search component"
---
...
Let's create a new Next.js application and install the related packages:
...
Call `npx @upstash/search-crawler` in your command line and follow the CLI,

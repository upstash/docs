...
if you already don't have one ([Getting Started guide](/search/overall/getstarted))
...
```bash
NEXT_PUBLIC_UPSTASH_REST_SEARCH_URL=<YOUR_SEARCH_REST_URL>
NEXT_PUBLIC_UPSTASH_REST_READONLY_TOKEN=<YOUR_SEARCH_READONLY_TOKEN>
```

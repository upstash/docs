...
The delete method allows you to delete documents from your collection using various criteria. You can delete documents by their IDs, by ID prefix or with fields filter.
...
<ResponseField name="DeletePayload" type="object" required>
  <Expandable defaultOpen="true">
    ...
    <ResponseField name="filter" type="string">
      A fields filter for document deletion.
      <Warning>

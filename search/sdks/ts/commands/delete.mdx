...
The delete method allows you to delete documents from your collection using various criteria. You can delete documents by their IDs, by ID prefix or with metadata filter.

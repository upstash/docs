...
If you require an extension beyond this limit, we kindly request that you submit a formal request to support@upstash.com.
</Warning>

When you create a Kafka cluster on the
[Upstash Console](https://console.upstash.com), a _default_ user credentials is
created automatically. _Default_ user credentials has _full access_ rights to
...
Credentials can be limited to _produce-only_ or _consume-only_ and also for a
...
page, and click the "_New Credentials_" button.
...
<Frame>
  <img src="/img/kafka/credentials/credentials.png" />
</Frame>
...
<Frame>
  <img src="/img/kafka/credentials/credentials-switch.png" />
</Frame>

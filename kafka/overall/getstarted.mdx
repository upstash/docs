...
You can sign up for <a href="https://console.upstash.com" target="_blank">Upstash</a> using your Amazon, GitHub, or Google accounts. Alternatively, you can choose to sign up using email/password registration if you prefer not to use these authentication providers or if you want to sign up using a corporate email address.
...
<Frame>
    <img
        src="/img/kafka/getting_started/create-cluster.png"
        class="ss"
        width="520"
    />
</Frame>
...
Upon clicking the _"Create"_ button, you will be presented with a list of your clusters as shown below:

<Frame>
    <img
        src="/img/kafka/getting_started/cluster-list.png"
        class="ss"
        width="100%"
    />{" "}
</Frame>
...
<Frame>
    <img
        src="/img/kafka/getting_started/tapic-tab.png"
        class="ss"
        width="100%"
    />
</Frame>

To create a new topic, switch to the "**Topics**" tab in cluster details page,
and click the _"Create topic"_ button:

<Frame>
    <img
        src="/img/kafka/getting_started/create-topic.png"
        class="ss"
        width="520"
    />
</Frame>
...
You can also change some advanced properties such as <Tooltip tip="etention time in Kafka determines how long messages are stored in a topic before they are eligible for deletion. It allows you to control how long data remains available for consumption.">`Retention Time`</Tooltip>
...
<Frame>
    <img
        src="/img/kafka/getting_started/topic-advanced.png"
        class="ss"
        width="425"
    />
</Frame>
...
<Frame>
    <img
        src="/img/kafka/getting_started/topics-list.png"
        class="ss"
        width="100%"
    />
</Frame>
...
<Frame>
    <img
        src="/img/kafka/getting_started/connect-clients.png"
        class="ss"
        width="100%"
    />
</Frame>
...
<Frame>
    <img
        src="/img/kafka/getting_started/connect-rest.png"
        class="ss"
        width="100%"
    />
</Frame>

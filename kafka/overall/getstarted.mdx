...
**Type:** Select to the cluster type. Currently there are only two options,
choose single replica for testing/development, multi replica for production use cases:

-   **Single Replica:** Topics created in the single replica cluster will have single
    replica only.
...
and click the "Create topic" button:

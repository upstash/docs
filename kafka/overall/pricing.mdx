...
import Trials from "../../common/trials.md";

import Enterprise from "./enterprise.md";
...
| Compliance (SOC2, GDPR ..)        | N/A         | [Learn more](help/compliance)                            | [Learn more](help/compliance)                         |
| **Price (per 100K messages)**     | **Free**    | Single Replica: **$0.2** <br/> Multi Replica: $0.6 <br/> | [Custom](#enterprise-plan)                            |
| **Price (per 1GB-month storage)** | **Free**    | **$0.25**                                                | [Custom](#enterprise-plan)                            |
...
Upstash limits your monthly cost for a cluster to a max price in pay-as-you-go plan.
Your single replica cluster can not cost more than $120 monthly ($360 for multi replica clusters).
After your cluster exceeds the max usage cost, your database will be rate limited.

## Pay-as-you-go Plan Quotas

_Pay as you go_ plan has soft limits which are introduced to ensure the fair use of resources among our users. Quotas are soft limits.
When your cluster reaches the quota we do not stop your service, but we will contact you and ask you to upgrade your service to an upper plan.
...
All limits are per cluster. If you think, your use case will exceed the above quotas, contact us (support@upstash.com) to update the quotas or check our [Pro/Enterprise Plans](#enterprise-plan) where the limits are higher.
...
Apply for an Pro/Enterprise plan in your cluster details page in the console. Contact [support@upstash.com](mailto:support@upstash.com) if you have custom needs or questions.

<Frame>
    <img src="/img/enterprise/kafka2.png" class="ss" width="720" />
</Frame>

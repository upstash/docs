...
<Info>
  Should your cluster surpass the daily bandwidth limit, we will notify you and
  suggest considering an upgrade to one of our higher-tier plans. Failure to
  upgrade will result in your cluster incurring a fee of $0.1 per GB for the
  bandwidth usage.
</Info>
...
<Note>
  All Pro/Enterprise plans have multiple replicas for high availability. Even if
  your first cluster is single-replica, replication is enabled with the upgrade.
</Note>

...
All limits are per cluster. If you think, your use case will exceed the above quotas, contact us (support@upstash.com) to update the quotas or check our [Pro/Enterprise Plans](#pro-enterprise-plans) where the limits are higher.

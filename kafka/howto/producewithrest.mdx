...
[Upstash Console](https://console.upstash.com), scroll down to the **REST API**
section and copy `UPSTASH_KAFKA_REST_URL`, `UPSTASH_KAFKA_REST_USERNAME` and
...
Replace the following parameters in the code snippets below with your actual values.
...
The following code will produce three city names to a topic:
...
producing them one by one. Note that in this case, the URL does not have the message

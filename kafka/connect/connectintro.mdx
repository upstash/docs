...
your Kafka cluster. This will get the burden of maintaining an extra system from
you and also it will be more performant since it will be close to your cluster.
...
[Pricing](../overall/pricing) for details on our per message pricing.
...
Directly proceed with **Create Cluster** as defaults should be fine. If this is
...
From here, you will be redirected to Database Deploymenyts screen. Go to
...
Header over to [console.upstash.com](https://console.upstash.com) and select
...
<Frame>
  <img src="/img/kafka/connect/mongo/source/1connector.png" width="520" />
</Frame>
...
<Frame>
  <img src="/img/kafka/connect/mongo/source/2config.png" width="520" />
</Frame>
...
<Frame>
  <img src="/img/kafka/connect/mongo/source/3advanced.png" width="520" />
</Frame>
...
<Frame>
  <img src="/img/kafka/connect/mongo/source/insert2.png" width="520" />
</Frame>

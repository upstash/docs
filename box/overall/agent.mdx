...
For every box, you can configure a built-in agent like Claude Code or Codex. It has access to the filesystem, git, and shell commands and should simulate running an Agent on your own computer.

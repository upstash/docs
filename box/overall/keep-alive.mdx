...
Init commands are not a keep-alive feature. Every box can have one, and get, set, and delete work on any box, including a paused one. See [Init Commands](/box/overall/init-commands) for the full behavior.

...
<Frame>
  <img src="/img/box/agent.png" alt="Box agent architecture diagram" />
</Frame>
...
<Frame>
  <img src="/img/box/lifecycle.png" alt="Box lifecycle diagram" />
</Frame>
...
If the box has an [init command](/box/overall/init-commands), the box runs it once after the container starts, on create, on resume, and after a snapshot restore.
...
Resuming reruns the box's [init command](/box/overall/init-commands), so a server started that way comes back with the box.
...
<Frame>
  <img src="/img/box/routing.png" alt="Box request routing diagram" />
</Frame>

...
without echo. If you pick the Claude subscription option, run `claude setup-token` in another
terminal, approve it in the browser, and paste the token it prints, so a Pro or Max plan works

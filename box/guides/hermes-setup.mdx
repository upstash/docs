...
<img src="/img/hermes-setup/box-create.png" alt="Create a Box for Hermes" />
...
<img src="/img/hermes-setup/ssh-connection.png" alt="SSH connection to the Hermes Box" />
...
<img src="/img/hermes-setup/init-script.png" alt="Hermes init script in the Upstash Console" />

...
Don't see your agent? The [Agent Skills CLI](https://github.com/vercel-labs/skills) installs skills into any agent that supports the [Agent Skills](https://agentskills.io/) format, and the MCP server works with any client that can run a stdio MCP server. See [Any other agent](/agent-resources/agents#any-other-agent).
...
<CardGroup cols={2}>
  ...
  <Card title="llms.txt" icon="file-lines" href="/agent-resources/llms-txt">

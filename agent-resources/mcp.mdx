...
<AccordionGroup>
  ...
  <Accordion title="Box — 14 tools">
    ...
    | `box_account` | read | `summary`, `billing`, `logs` — each active box with its cost (`status: deleted` for the deleted ones), this month's totals, and log lines across all boxes |
